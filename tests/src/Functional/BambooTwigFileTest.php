...
class BambooTwigFileTest extends BambooTwigTestBase {
  ...
  public function testUrlAbsolute() {
    ...
    $this->assertElementContains('.test-files div.url-module-file-relative', '/modules/contrib/bamboo_twig/tests/bamboo_twig_test/files/antistatique.jpg');
    ...
    $this->assertElementContains('.test-files div.url-module-file-absolute', '/modules/contrib/bamboo_twig/tests/bamboo_twig_test/files/antistatique.jpg');
  }
